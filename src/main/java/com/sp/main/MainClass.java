...
import com.sp.main.excel.ExcelUtils;
...
public class MainClass {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String url = "https://store.coupang.com/vp/vendors/A00163079/product/lists?outboundShippingPlaceId=&attributeFilters=&brand=&componentId=&keyword=&maxPrice=&minPrice=&pageNum=1&rating=0&sortTypeValue=&scpLanding=true";
...
//            System.out.println(images);
        ...
        ExcelUtils.writeExcel( "H:\\Downloads\\img\\eee.xls", "price", listTit, values);
    }
